...
-- @Last Modified time: 2023-01-28 09:36:19
--========================================,==============================--
local 场景类_新宠物炼妖栏 = class()
...
function 场景类_新宠物炼妖栏:初始化(根)
	self.ID = 1301111111111
	self.x = 289
	self.y = 119
	self.xx = 0
	self.yy = 0
	...
	self.资源组 = {
		...
		[7] = 根.资源:载入('wzife.wd1',"网易WDF动画",0x62F1C735),
...
function 场景类_新宠物炼妖栏:检查点(x,y)
	if self.资源组[1]:是否选中(x,y)  then
		return true
	end
end

function 场景类_新宠物炼妖栏:初始移动(x,y)
	tp.运行时间 = tp.运行时间 + 1
