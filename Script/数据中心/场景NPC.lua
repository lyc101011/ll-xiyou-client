...
-- @Last Modified time: 2024-12-27 22:52:04
function 场景取假人表(地图ID,假人ID,是否)
	...
	--	假人[5] = {名称="镖师",称谓="",模型="护卫",X=135,Y=20,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
...
--		假人[9] = {名称="慕容婆婆",模型="女人_孟婆",X=84,Y=33,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 6227 then --武神坛，新增地图
    	...
    	假人[15] = {名称="宠物仙子",模型="普陀_接引仙女",X=56,Y=32,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    	假人[16] = {名称="染色师",模型="女人_染色师",X=59,Y=31,方向=4,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    	假人[17] = {名称="武器大师",模型="男人_武器店老板",X=46,Y=38,方向=4,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1001 then
	    ...
	    -- 假人[2] = {名称="宠物仙子",模型="普陀_接引仙女",X=221,Y=99,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
...
--		假人[92] = {名称="婵娟",称谓="中秋佳节活动",模型="女人_满天星",X=229,Y=158,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	--	假人[105] = {名称="传令天兵",模型="天兵",X=212,Y=113,方向=0,事件ID=nil,执行事件="不执行"}   --神器任务  神器副本npc
	...
	--	假人[136] = {名称="西游传说",模型="唐僧",称谓="传说副本",X=257,Y=167,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
      ...
      --假人[143] = {名称="云游仙人",模型="符石道人",X=268,Y=93,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    ...
	    假人[181] = {名称="梦幻百科",称谓="活动大全",模型="自在天魔刀",X=205,Y=116,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=6}
	    假人[191] = {名称="修业指导师",模型="巫师",称谓="",X=225,Y=135,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		-----------------------------
    --书香斋
    --剑会天下
	...
	elseif 地图ID == 1016  then
		...
		假人[2] = {名称="陆祁安",模型="男人_书生",X=21,Y=26,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0} --314更新
		假人[3] = {名称="木轻柔",模型="飞燕女",X=32,Y=20,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	--平安福寿
	...
	--	假人[7] = {名称="陆云鹤",模型="男人_书生",X=101,Y=52,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0} --314更新
	--	假人[8] = {名称="陆祁安",模型="男人_书生",X=95,Y=60,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0} --314更新
	...
	elseif 地图ID == 1205 then
		假人[1] = {名称="蚩尤元神",模型="蚩尤",X=63,Y=45,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 10000 then --云影储备室
    	假人[1] = {名称="传送大使",模型="男人_马副将",X=64,Y=39,方向=0,显示饰品=true,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1197 then --比武场
		假人[1] = {名称="比武大会传送人",模型="男人_将军",X=64,Y=39,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
